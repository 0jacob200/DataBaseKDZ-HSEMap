...
BEGIN
  DECLARE  @errno   int,
           ...
           @errmsg  varchar(255)
    /* erwin Builtin Trigger */
    /* Campus  Schedule_Campus on parent delete no action */
    /* ERWIN_RELATION:CHECKSUM="0003016f", PARENT_OWNER="", PARENT_TABLE="Campus"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Campus"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_28", FK_COLUMNS="Campus_Name" */
    IF EXISTS (
      SELECT * FROM deleted,Schedule_Campus
      WHERE
        /*  %JoinFKPK(Schedule_Campus,deleted," = "," AND") */
        Schedule_Campus.Campus_Name = deleted.Campus_Name
    )
    BEGIN
      SELECT @errno  = 30001,
             @errmsg = 'Cannot delete Campus because Schedule_Campus exists.'
      GOTO error
    END
...
BEGIN
  ...
  /* erwin Builtin Trigger */
  /* Campus  Schedule_Campus on parent update no action */
  /* ERWIN_RELATION:CHECKSUM="00033dd5", PARENT_OWNER="", PARENT_TABLE="Campus"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Campus"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_28", FK_COLUMNS="Campus_Name" */
  IF
  ...
  BEGIN
    ...
    BEGIN
      SELECT @errno  = 30005,
             @errmsg = 'Cannot update Campus because Schedule_Campus exists.'
      GOTO error
    END
  END
...
BEGIN
  DECLARE  @errno   int,
    ...
    /* ERWIN_RELATION:CHECKSUM="00035b46", PARENT_OWNER="", PARENT_TABLE="Organisation"
    ...
    /* erwin Builtin Trigger */
    /* Organisation  Schedule_Organisation on parent delete no action */
    /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="Organisation"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Organisation"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_37", FK_COLUMNS="ID_Organisation" */
    IF EXISTS (
      SELECT * FROM deleted,Schedule_Organisation
      WHERE
        /*  %JoinFKPK(Schedule_Organisation,deleted," = "," AND") */
        Schedule_Organisation.ID_Organisation = deleted.ID_Organisation
    )
    BEGIN
      SELECT @errno  = 30001,
             @errmsg = 'Cannot delete Organisation because Schedule_Organisation exists.'
      GOTO error
    END
...
BEGIN
  ...
  /* ERWIN_RELATION:CHECKSUM="0003b575", PARENT_OWNER="", PARENT_TABLE="Organisation"
    CHILD_OWNER="", CHILD_TABLE="Education_program"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_46", FK_COLUMNS="ID_Organisation" */
  IF
  ...
  /* erwin Builtin Trigger */
  /* Organisation  Schedule_Organisation on parent update no action */
  /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="Organisation"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Organisation"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_37", FK_COLUMNS="ID_Organisation" */
  ...
  BEGIN
    ...
    BEGIN
      SELECT @errno  = 30005,
             @errmsg = 'Cannot update Organisation because Schedule_Organisation exists.'
      GOTO error
    END
  END
...
BEGIN
  DECLARE  @errno   int,
           ...
           @errmsg  varchar(255)
    /* erwin Builtin Trigger */
    /* Labor_day  Schedule_Organisation on parent delete no action */
    /* ERWIN_RELATION:CHECKSUM="00038095", PARENT_OWNER="", PARENT_TABLE="Labor_day"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Organisation"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    ...
    IF EXISTS (
      ...
      WHERE
        /*  %JoinFKPK(Schedule_Organisation,deleted," = "," AND") */
        Schedule_Organisation.ID_Labor_day = deleted.ID_Labor_day
    )
    BEGIN
      SELECT @errno  = 30001,
             @errmsg = 'Cannot delete Labor_day because Schedule_Organisation exists.'
      GOTO error
    END

    /* erwin Builtin Trigger */
    /* Labor_day  Schedule_Campus on parent delete no action */
    ...
    IF EXISTS (
      ...
      WHERE
        /*  %JoinFKPK(Schedule_Campus,deleted," = "," AND") */
        Schedule_Campus.ID_Labor_day = deleted.ID_Labor_day
    )
    BEGIN
      SELECT @errno  = 30001,
             @errmsg = 'Cannot delete Labor_day because Schedule_Campus exists.'
      GOTO error
    END
...
BEGIN
  ...
  SELECT @numrows = @@rowcount
  /* erwin Builtin Trigger */
  /* Labor_day  Schedule_Organisation on parent update no action */
  /* ERWIN_RELATION:CHECKSUM="0003d56c", PARENT_OWNER="", PARENT_TABLE="Labor_day"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Organisation"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_36", FK_COLUMNS="ID_Labor_day" */
  IF
  ...
  BEGIN
    ...
    BEGIN
      SELECT @errno  = 30005,
             @errmsg = 'Cannot update Labor_day because Schedule_Organisation exists.'
      GOTO error
    END
  END

  /* erwin Builtin Trigger */
  /* Labor_day  Schedule_Campus on parent update no action */
  /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="Labor_day"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Campus"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_27", FK_COLUMNS="ID_Labor_day" */
  ...
  BEGIN
    ...
    BEGIN
      SELECT @errno  = 30005,
             @errmsg = 'Cannot update Labor_day because Schedule_Campus exists.'
      GOTO error
    END
  END
...
CREATE TRIGGER tD_Labor_day_Campus ON Schedule_Campus FOR DELETE AS
/* erwin Builtin Trigger */
/* DELETE trigger on Schedule_Campus */
BEGIN
  DECLARE  @errno   int,
           @severity int,
           @state    int,
           @errmsg  varchar(255)
    /* erwin Builtin Trigger */
    /* Campus  Schedule_Campus on child delete no action */
    /* ERWIN_RELATION:CHECKSUM="0002966b", PARENT_OWNER="", PARENT_TABLE="Campus"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Campus"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_28", FK_COLUMNS="Campus_Name" */
    IF EXISTS (SELECT * FROM deleted,Campus
      WHERE
        ...
        deleted.Campus_Name = Campus.Campus_Name AND
        NOT EXISTS (
          SELECT * FROM Schedule_Campus
          WHERE
            /* %JoinFKPK(Schedule_Campus,Campus," = "," AND") */
            Schedule_Campus.Campus_Name = Campus.Campus_Name
        )
    )
    BEGIN
      SELECT @errno  = 30010,
             @errmsg = 'Cannot delete last Schedule_Campus because Campus exists.'
      GOTO error
    END

    /* erwin Builtin Trigger */
    /* Labor_day  Schedule_Campus on child delete no action */
    /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="Labor_day"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Campus"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_27", FK_COLUMNS="ID_Labor_day" */
    IF EXISTS (SELECT * FROM deleted,Labor_day
      WHERE
        ...
        NOT EXISTS (
          SELECT * FROM Schedule_Campus
          WHERE
            /* %JoinFKPK(Schedule_Campus,Labor_day," = "," AND") */
            Schedule_Campus.ID_Labor_day = Labor_day.ID_Labor_day
        )
    )
    BEGIN
      SELECT @errno  = 30010,
             @errmsg = 'Cannot delete last Schedule_Campus because Labor_day exists.'
      GOTO error
    END
...
CREATE TRIGGER tU_Labor_day_Campus ON Schedule_Campus FOR UPDATE AS
/* erwin Builtin Trigger */
/* UPDATE trigger on Schedule_Campus */
BEGIN
  DECLARE  @numrows int,
           @nullcnt int,
           @validcnt int,
  ...
  SELECT @numrows = @@rowcount
  /* erwin Builtin Trigger */
  /* Campus  Schedule_Campus on child update no action */
  /* ERWIN_RELATION:CHECKSUM="0002c27e", PARENT_OWNER="", PARENT_TABLE="Campus"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Campus"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_28", FK_COLUMNS="Campus_Name" */
  IF
  ...
  BEGIN
    ...
    BEGIN
      SELECT @errno  = 30007,
             @errmsg = 'Cannot update Schedule_Campus because Campus does not exist.'
      GOTO error
    END
  END

  /* erwin Builtin Trigger */
  /* Labor_day  Schedule_Campus on child update no action */
  /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="Labor_day"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Campus"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_27", FK_COLUMNS="ID_Labor_day" */
  ...
  BEGIN
    ...
    BEGIN
      SELECT @errno  = 30007,
             @errmsg = 'Cannot update Schedule_Campus because Labor_day does not exist.'
      GOTO error
    END
  END
...
CREATE TRIGGER tD_Labor_day_Organisation ON Schedule_Organisation FOR DELETE AS
/* erwin Builtin Trigger */
/* DELETE trigger on Schedule_Organisation */
BEGIN
  DECLARE  @errno   int,
           @severity int,
           @state    int,
           @errmsg  varchar(255)
    /* erwin Builtin Trigger */
    /* Organisation  Schedule_Organisation on child delete no action */
    /* ERWIN_RELATION:CHECKSUM="0002e521", PARENT_OWNER="", PARENT_TABLE="Organisation"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Organisation"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_37", FK_COLUMNS="ID_Organisation" */
    IF EXISTS (SELECT * FROM deleted,Organisation
      WHERE
        ...
        deleted.ID_Organisation = Organisation.ID_Organisation AND
        NOT EXISTS (
          SELECT * FROM Schedule_Organisation
          WHERE
            /* %JoinFKPK(Schedule_Organisation,Organisation," = "," AND") */
            Schedule_Organisation.ID_Organisation = Organisation.ID_Organisation
        )
    )
    BEGIN
      SELECT @errno  = 30010,
             @errmsg = 'Cannot delete last Schedule_Organisation because Organisation exists.'
      GOTO error
    END

    /* erwin Builtin Trigger */
    /* Labor_day  Schedule_Organisation on child delete no action */
    /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="Labor_day"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Organisation"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_36", FK_COLUMNS="ID_Labor_day" */
    IF EXISTS (SELECT * FROM deleted,Labor_day
      WHERE
        ...
        NOT EXISTS (
          SELECT * FROM Schedule_Organisation
          WHERE
            /* %JoinFKPK(Schedule_Organisation,Labor_day," = "," AND") */
            Schedule_Organisation.ID_Labor_day = Labor_day.ID_Labor_day
        )
    )
    BEGIN
      SELECT @errno  = 30010,
             @errmsg = 'Cannot delete last Schedule_Organisation because Labor_day exists.'
      GOTO error
    END
...
CREATE TRIGGER tU_Labor_day_Organisation ON Schedule_Organisation FOR UPDATE AS
/* erwin Builtin Trigger */
/* UPDATE trigger on Schedule_Organisation */
BEGIN
  DECLARE  @numrows int,
           @nullcnt int,
           @validcnt int,
  ...
  SELECT @numrows = @@rowcount
  /* erwin Builtin Trigger */
  /* Organisation  Schedule_Organisation on child update no action */
  /* ERWIN_RELATION:CHECKSUM="0002ff52", PARENT_OWNER="", PARENT_TABLE="Organisation"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Organisation"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_37", FK_COLUMNS="ID_Organisation" */
  IF
  ...
  BEGIN
    ...
    BEGIN
      SELECT @errno  = 30007,
             @errmsg = 'Cannot update Schedule_Organisation because Organisation does not exist.'
      GOTO error
    END
  END

  /* erwin Builtin Trigger */
  /* Labor_day  Schedule_Organisation on child update no action */
  /* ERWIN_RELATION:CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="Labor_day"
    CHILD_OWNER="", CHILD_TABLE="Schedule_Organisation"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_36", FK_COLUMNS="ID_Labor_day" */
  ...
  BEGIN
    ...
    BEGIN
      SELECT @errno  = 30007,
             @errmsg = 'Cannot update Schedule_Organisation because Labor_day does not exist.'
      GOTO error
    END
  END
