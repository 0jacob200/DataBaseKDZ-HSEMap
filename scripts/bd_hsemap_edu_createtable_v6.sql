...
( 
	...
	[Organisation_Name]  nvarchar(50)  NOT NULL ,
...
( 
	...
	CONSTRAINT [XPKRoom] PRIMARY KEY  CLUSTERED ([Campus_Name] ASC,[Building] ASC,[Room_Number] ASC),
	CONSTRAINT [R_6] FOREIGN KEY ([Campus_Name],[Building]) REFERENCES [Building]([Campus_Name],[Building_Name])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
)
go
...
( 
	...
	[Room_Number]        nvarchar(10)  NOT NULL ,
	[ID_Organisation]    integer  NOT NULL ,
	CONSTRAINT [XPKRoom_Organisation] PRIMARY KEY  CLUSTERED ([Campus_Name] ASC,[Building] ASC,[Room_Number] ASC,[ID_Organisation] ASC),
	CONSTRAINT [R_30] FOREIGN KEY ([Campus_Name],[Building],[Room_Number]) REFERENCES [Room]([Campus_Name],[Building],[Room_Number])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION,
...
( 
	...
	[Email_of_Professor] varchar(40)  NOT NULL ,
	CONSTRAINT [XPKProfessor] PRIMARY KEY  CLUSTERED ([Email_of_Professor] ASC)
)
go
...
( 
	...
	[Email_of_Professor] varchar(40)  NULL ,
	...
	CONSTRAINT [R_14] FOREIGN KEY ([ID_Time_span]) REFERENCES [Time_span]([ID_Time_span])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION,
	CONSTRAINT [R_17] FOREIGN KEY ([Email_of_Professor]) REFERENCES [Professor]([Email_of_Professor])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION,
	CONSTRAINT [R_18] FOREIGN KEY ([Campus_Name],[Building_Name],[Room_Number]) REFERENCES [Room]([Campus_Name],[Building],[Room_Number])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
)
go
